...
public class PixulPhysicsAI : MonoBehaviour 
{
    ...
    {        
        ...
        if (Input.GetButtonDown("Fire1") && BarController.moveBar == false || (Input.GetKey("space") && m_Pressed && BarController.moveBar == false))
        {
    ...
    public void fire()
    {
        ...
        {
            m_init_velocity = keyVelocity - new Vector2(Random.Range(-0.8f, 0.8f), Random.Range(-0.8f, 0.8f));
        }
